...
internal class TestMethodGenerator : MemberGenerator
{
    ...
    private void AddAssertSectionVoidMethod(ICollection<StatementSyntax> statements, MethodDeclarationSyntax method)
    {
        statements.Add(
            ExpressionStatement(
                InvocationExpression(
    ...
    private void AddAssertSectionNotVoidMethod(ICollection<StatementSyntax> statements, MethodDeclarationSyntax method)
    {
        statements.Add(
                LocalDeclarationStatement(
                    VariableDeclaration(
